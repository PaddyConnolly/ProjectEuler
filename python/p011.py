def calculate():
    ...
    for i in range(0, len(GRID)-3):
        for j in range(0, len(GRID)-3):
            ...
            product = int(GRID[j][i]) * int(GRID[j][i+1]) * \
                int(GRID[j][i+2]) * int(GRID[j][i+3])
            if product > highest:
                highest = product
    ...
    for i in range(0, len(GRID)):
        for j in range(0, len(GRID)-3):
            product = int(GRID[j][i]) * int(GRID[j+1][i]) * \
    ...
    for i in range(0, len(GRID)-3):
        for j in range(0, len(GRID)-3):
            product = int(GRID[j][i]) * int(GRID[j+1][i+1]) * \
                int(GRID[j+2][i+2]) * int(GRID[j+3][i+3])
            if product > highest:
                highest = product

    # Diagonal Top Right to Bottom Left
    for i in range(len(GRID)-1, 3, -1):
        for j in range(0, len(GRID)-3):
            product = int(GRID[j][i]) * int(GRID[j+1][i-1]) * \
                int(GRID[j+2][i-2]) * int(GRID[j+3][i-3])
            if product > highest:
